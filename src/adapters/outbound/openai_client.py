    ...
    def _call_and_process(self, prompt_user_message: str, prompt_system_message: str, model: str) -> list[str]:
        ...
        try:
            response = client.chat.completions.create(
                ...
                temperature=1.0,            #  0.0 to 2.0 --> Nivel de creatividad/aleatoriedad. Valores bajos → respuestas más deterministas y “seguras”. Valores altos → más creatividad y variación, pero también más riesgo de desviarse del tema.
