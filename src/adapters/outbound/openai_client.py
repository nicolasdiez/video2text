    ...
    def _call_and_process(self, prompt: str, max_sentences: int, model: str) -> list[str]:
        ...
        system_message = {
            ...
            "content": (
                ...
                f"in Spanish (ESPAÑOL) that feel personal, relatable, and directly connected to the video's story.\n\n"
                ...
                f"5. Model your tweets closely on the style, tone, and structure of the examples provided below.\n\n"
        ...
        response = client.chat.completions.create(
            ...
            temperature=0.9,            #  0.0 to 2.0 --> Nivel de creatividad/aleatoriedad. Valores bajos → respuestas más deterministas y “seguras”. Valores altos → más creatividad y variación, pero también más riesgo de desviarse del tema.
