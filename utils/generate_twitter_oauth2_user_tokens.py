...
# Script used to generate the Twitter user tokens: X_OAUTH2_ACCESS_TOKEN, X_OAUTH2_ACCESS_TOKEN_EXPIRES_AT, X_OAUTH2_REFRESH_TOKEN and X_OAUTH2_REFRESH_TOKEN_EXPIRES_AT from the email and pass of the user.
